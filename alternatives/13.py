...
SMOOTHING_FACTOR = 0.7  # Not directly used by PID but kept for historical reasons
...
# ----------------- New: Create PID controller instance -----------------
...
def process_frame(frame, arduino):
    ...
    try:
        ...
        # Only send command if it has changed to reduce redundant communication
